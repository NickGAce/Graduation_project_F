...
Это клиентская (фронтенд) часть информационной системы для управления студенческим общежитием. Интерфейс разработан для **администраторов общежития** и обеспечивает доступ ко всем функциям системы через современный веб-интерфейс. 
